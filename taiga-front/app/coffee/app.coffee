...
configure = ($routeProvider, $locationProvider, $httpProvider, $provide, $tgEventsProvider, $compileProvider,
    ...
    $routeProvider.when("/project/:pslug/planningpoker",
        {
            templateUrl: "planningpoker/planningpoker.html",
            loader: true,
            section: "planningpoker"
        }
    )
    
    #Daily Scrum
    $routeProvider.when("/project/:pslug/dailyscrum",
        {
            templateUrl: "dailyscrum/dailyscrum.html",
            loader: true,
            section: "dailyscrum"
        }
    )
    ...
    # Sprint Review
    $routeProvider.when("/project/:pslug/sprintreview",
        {
            templateUrl: "sprintreview/sprintreview.html",
            loader: true,
            section: "sprintreview"
        }
    )

    # Sprint Retrospective
    $routeProvider.when("/project/:pslug/sprintretrospective",
        {
            templateUrl: "sprintretrospective/sprintretrospective.html",
            loader: true,
            section: "sprintretrospective"
        }
    )
