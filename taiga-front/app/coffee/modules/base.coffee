...
urls = {
    ...
    # PlanningPoker
    "project-planningpoker": "/project/:project/planningpoker"

    # DailyScrum
    "project-dailyscrum": "/project/:project/dailyscrum"

    # SprintReview
    "project-sprintreview": "/project/:project/sprintreview"

    # SprintRetrospective
    "project-sprintretrospective": "/project/:project/sprintretrospective"
